...
namespace Lokad.Cloud.Storage.Tables
{
    ...
    public interface ITableStorageProvider
    {
        ...
        ///                                                                                                                                                                                                  fail if one or several entities have changed remotely in the meantime. If
        ///                                                                                                                                                                                                  <c>true</c>
        ///                                                                                                                                                                                                  ,
        ...
        /// </returns>
        /// <remarks>
        /// The enumeration is typically expected to be lazy, iterating through all the entities with paged request. If the table does not exist, an empty enumeration is returned.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        /// The enumeration is typically expected to be lazy, iterating through all the entities with paged request. If the table does not exists, or if the partition does not exists, an empty enumeration is returned.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        /// The enumeration is typically expected to be lazy, iterating through all the entities with paged request.The enumeration is ordered by row key. If the table or the partition key does not exist, the returned enumeration is empty.
        /// </remarks>
        ...
        /// </returns>
        /// <remarks>
        /// The enumeration is typically expected to be lazy, iterating through all the entities with paged request. If the table or the partition key does not exist, the returned enumeration is empty.
        /// </remarks>
        ...
        /// <remarks>
        /// <para>
        /// The call is expected to fail on the first encountered already-existing
        ...
        /// </para>
        /// <para>
        /// If the table does not exist then it should be created.
        /// </para>
        ...
        ///                                                                                         <c>false</c>
        ///                                                                                         , the call is expected to
        ///                                                                                         fail if one or several entities have changed in the meantime. If
        ///                                                                                         <c>true</c>
        ///                                                                                         ,
        ...
        /// <remarks>
        /// <para>
        /// New entities will be inserted. Existing entities will be updated,
